...
/// Errors returned when connecting to or pinging Postgres.
pub enum DbError {
...
/// Connects to Postgres and returns a pooled connection handle.
///
/// # Examples
///
/// ```rust,no_run
...
/// Executes a lightweight query to verify the pool can reach the database.
///
/// # Examples
///
/// ```rust,no_run
