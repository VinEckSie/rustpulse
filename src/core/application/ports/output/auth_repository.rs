...
pub trait UserRepo {
    ...
    fn insert_user(&self, email: &Email, password_hash: &PasswordHash) -> Result<UserId, UserRepoError>;
...
pub trait PasswordHasher {
    ...
    fn verify(&self, password: &Password, hash: &PasswordHash) -> Result<bool, PasswordHasherError>;
}
